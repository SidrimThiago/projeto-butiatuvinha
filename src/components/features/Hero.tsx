        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <div className="inline-flex items-center px-4 py-2 bg-accent rounded-full">
                <Image src="@/assets/images/logo-prefeitura.png" alt="Prefeitura de Curitiba" className="w-4 h-4 mr-2" />
          ...
          <div className="relative">
            <div className="relative rounded-2xl overflow-hidden shadow-2xl">
              <ImageWithFallback
                src="https://images.unsplash.com/photo-1600792170156-7fdc12ed6733?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNsYXJjaHwxfHxjaGlsZHJlbiUyMGhhcHB5JTIwc2Nob29sJTIwY3VyaXRpYmF8ZW58MXx8fHwxNzU3ODEyMjMyfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
